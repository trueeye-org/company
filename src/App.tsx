...
function App() {
  ...
  return (
    <div className="relative w-full h-full bg-black">
      ...
      <div className="w-full py-16 flex items-center justify-center bg-gradient-to-b from-black via-gray-950 to-black border-t border-amber-500/30">
        <div className="w-4/5 max-w-[1280px] flex flex-col items-center justify-center">
          ...
          <div className="flex justify-center gap-6 mb-10">
            <a 
              href="https://www.linkedin.com/company/trueeye/" 
              target="_blank" 
            ...
            <a 
              href="https://www.facebook.com/share/17BsQiGaNQ/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-300 hover:text-blue-500 hover:bg-gray-700 transition-all duration-300"
              aria-label="Facebook"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a 
              href="https://www.reddit.com/user/Master-Talk-6537/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-300 hover:text-red-400 hover:bg-gray-700 transition-all duration-300"
              aria-label="Reddit"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a 
              href="https://x.com/TrueEye__" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-300 hover:text-black hover:bg-gray-700 transition-all duration-300"
          ...
          <div className="text-center">
            <p className="text-gray-400 mb-2">&copy; {new Date().getFullYear()} TrueEye. All rights reserved.</p>
            <p className="text-gray-500 text-sm">Premium Recruitment Tool for CV Analysis</p>
          </div>
        </div>
      </div>
    </div>
